...
![AIOS Dashboard](aios_dashboard_react/public/placeholder.svg)
<!-- Replace the placeholder above with a real screenshot: aios_dashboard_react/docs/screenshot-dashboard.png -->
...
- **Dashboards** — Blazor Server (`aios_dashboard_csharp`, .NET 8) and React + Vite (`aios_dashboard_react`) sharing the same SQLite source of truth
...
| React dashboard | React 18, Vite 5, TypeScript 5, Tailwind, Radix, Framer Motion, Recharts/visx |
...
├── aios_dashboard_react/   # React + Vite dashboard
