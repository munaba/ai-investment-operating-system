            ...
            <div className="bg-muted/50 py-24">
                <div className="mx-auto w-full max-w-5xl px-6">
                    <div>
                        ...
                        <h2 className="text-foreground mt-4 text-4xl font-semibold">Ask Vengeance UI to Edit anything</h2>
                        <p className="text-muted-foreground mb-12 mt-4 text-lg">Efficient content creation is our mission. With Vengeance UI, you can effortlessly edit text, generate code snippets, format documents, create visualizations from data, and seamlessly integrate with your existing workflow.</p>
                    </div>
