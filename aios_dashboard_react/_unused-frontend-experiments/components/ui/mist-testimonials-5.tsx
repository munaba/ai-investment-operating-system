                ...
                <div className="mx-auto w-full max-w-2xl px-6 text-center">
                    <div className="max-w-xl">
                        ...
                        <blockquote className="mt-6">
                            <p className="text-foreground text-xl">Using Vengeance UI has been like unlocking a secret design superpower. It's the perfect fusion of simplicity and versatility, enabling us to create UIs that are as stunning as they are user-friendly.</p>
